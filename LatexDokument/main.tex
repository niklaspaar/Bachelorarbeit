...
\textbf{Funktionsweise:} Bei diesem Scheduling-Algorithmus werden die Aufträge nach der sogenannten \textit{Response Ration} sortiert. Die Response Ratio wird berechnet als: $\frac{\text{Wartezeit} + \text{Bearbeitungszeit}}{\text{Bearbeitungszeit}}$.\citep[Vgl.]{simic2024hrrn}
